  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
          ...
          // Deep blue palette matching GRIFA primary color
          vec3 baseColor = vec3(0.02, 0.06, 0.11);
          vec3 mistColor = vec3(0.043, 0.122, 0.227);
          vec3 accentColor = vec3(0.10, 0.22, 0.42);
